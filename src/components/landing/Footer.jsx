    ...
    <footer className="bg-slate-900 text-white pt-24 pb-10 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 border-t border-white/10 pt-8 text-sm text-slate-400">
          <p className="font-extrabold text-white text-lg" style={{ fontStyle: "italic" }}>
            <span className="text-[#00D1FF]">P</span>romote
          </p>
          <nav className="flex items-center gap-6 font-semibold">
            ...
            <a href="mailto:support@promote.sh" className="hover:text-white transition-colors">Contact Support</a>
          </nav>
          <p>© {new Date().getFullYear()} Promote. All rights reserved.</p>
        </div>
      </div>
