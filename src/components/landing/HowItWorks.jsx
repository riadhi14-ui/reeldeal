    ...
    <section id="how-it-works" className="py-32 bg-[#F8FAFC]">
      <div className="max-w-7xl mx-auto px-6">
        <motion.div {...fadeUp} className="text-center mb-20">
          <p className="text-sm font-bold text-[#DC2626] uppercase tracking-widest mb-3">How It Works</p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <motion.div {...fadeUp} className="bg-white rounded-3xl p-8 shadow-sm ring-1 ring-slate-100 flex flex-col">
            ...
            <div className="mt-auto">
              <p className="text-xs font-bold text-[#DC2626] uppercase tracking-widest mb-2">Step 1</p>
          ...
          <motion.div {...fadeUp} transition={{ duration: 0.5, delay: 0.1 }} className="bg-white rounded-3xl p-8 shadow-sm ring-1 ring-slate-100 flex flex-col">
            <div className="mb-8">
              ...
              <div className="mt-3 h-11 rounded-xl bg-[#EF4444] text-white text-sm font-bold flex items-center justify-center">Submit for Review</div>
            </div>
            <div className="mt-auto">
              <p className="text-xs font-bold text-[#DC2626] uppercase tracking-widest mb-2">Step 2</p>
          ...
          <motion.div {...fadeUp} transition={{ duration: 0.5, delay: 0.2 }} className="bg-white rounded-3xl p-8 shadow-sm ring-1 ring-slate-100 flex flex-col">
            <div className="mb-8 rounded-2xl bg-slate-900 p-5 text-white">
              ...
              <div className="mt-3 h-10 rounded-xl bg-[#EF4444] text-white text-sm font-bold flex items-center justify-center">Withdraw Funds</div>
            </div>
            <div className="mt-auto">
              <p className="text-xs font-bold text-[#DC2626] uppercase tracking-widest mb-2">Step 3</p>
