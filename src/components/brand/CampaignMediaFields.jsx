...
export default function CampaignMediaFields({ image, videos, onImage, onVideos, onUploading, onError }) {
  ...
  return (
    <section className="space-y-5 rounded-2xl border border-slate-200 p-4">
      ...
      <div><p className="text-sm font-semibold mb-2">Image de couverture</p><label className="flex min-h-28 cursor-pointer items-center justify-center rounded-xl border-2 border-dashed border-slate-200 bg-slate-50 overflow-hidden">
